...
/*   Updated: 2020/08/04 19:20:33 by jwon             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			convert_xpm_to_img(t_game *game)
{
	...
	set_coin("./textures/mario/key.xpm", game);
	set_fence("./textures/mario/fence1.xpm", game);
	set_yeji("./textures/mario/yeji.xpm", game);
}
